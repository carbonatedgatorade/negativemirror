...
> We know very little about the mechanism of memory. 
> 
> Some hold that all the workings of the mind transcend substance (though they derive from a physical object, making them as material as anything else). But there is Memǒar, that great complication; if it’s true that there is a flower for each of us, a vessel of our memories, what does that mean for the relationship between body and mind? 
> 
> Is there a vast spell that works upon us at all times, heretofore undetected? Possible, though many have tested this hypothesis and found it lacking. Are we all outgrowths of the garden itself? Improbable, for the Telling speaks of its construction. 
> 
> Is it something more fundamental, then? That the garden, like us, is of the world, and so is connected to each of us, the world’s children? As good an explanation as any. 
> 
> There is much we do not understand. 

— *Commentary from the painting ‘Garden of Memory’, by the Remembrancer Hyewon*

---
# Making Memories

*First, separate your deck into major and minor acana.* 

To assemble a memory, draw two **major arcana** and three **minor arcana**. 

Lay out your cards in a cross formation, with your major arcana serving as the top and bottom parts of the cross. You need not necessarily order them in the way they were drawn—reverse cards and modify their placement as desired to produce a memory that feels right for your character. 
...
<center><em>In this diagram 1 and 5 represent the major arcana, while 2, 3, and 4 are the minor arcana.</center></em>

**Use the key below to determine the questions you will answer to construct your memory.**

## Upright
1. What type of memory is this?
2.  What was the most important part of this memory when it happened? What's the most important part now?
3. How has this event changed you for the better? 
4. What image, sound, or feeling from this memory will always stick with you?
5. How might you honor this memory, or act upon it? 

## Reversed
1. What type of memory is this? 
2. What did you wish you had done differently when this happened? What do you wish you could have done differently now? 
3. How has this event changed you for the worse? 
4. What image, sound, or feeling from this memory do you wish had remained forgotten?
5. How might you deny this memory, or turn away from it?

---
# Additional Actors
If the memory contains multiple people, you might have the Warden or your fellow players take on additional roles to fill the memory out.
# Adding Detail 
You may invite others at the table to provide additional details to the memory. 

Examples: *it was raining that day, but the leaves of the trees overhead kept you dry | the sky was the color of sapphires | the smell of cinnamon was on the wind | there was music playing somewhere nearby | the drinks you were sharing tasted of honey and pepper*
...
> 
> The following cards are drawn, and **Puck** assigns a loose meaning to each.
> 1. Temperance, reversed — A lack of faith
> 2. The Knight of Rods — Restlessness / pursuit of goals
> 3. The Four of Rods — Material, emotional, spiritual blessings / diligent effort
> 4. The Nine of Pentacles, reversed — Awkward entanglement / poor judgement
> 5. The Hermit — reevaluation of goals, reflection on the self
> 
